   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, kTitleYOffset, kAlertWidth, size.height)];
...
#define kButtonBottomOffset 10.0f
        if (!leftTitle) {
            ...
            leftBtnFrame = CGRectMake((kAlertWidth - 2 * kCoupleButtonWidth - kButtonBottomOffset) * 0.5, CGRectGetMaxY(self.alertContentLabel.frame)+5.0, kCoupleButtonWidth, kButtonHeight);
            rightBtnFrame = CGRectMake(CGRectGetMaxX(leftBtnFrame) + kButtonBottomOffset, CGRectGetMaxY(self.alertContentLabel.frame)+5.0, kCoupleButtonWidth, kButtonHeight);
